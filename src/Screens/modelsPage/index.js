        ...
        <div className='row'>
            ...
            <div className='all_filters_with_search'>
              ...
              <div className="dropdown">
                <button className='sign_actionBtn btn dropdown-toggle' type="button" data-toggle="dropdown" aria-expanded="false">add filter</button>
              ...
              <label className='sortby_label m-0'>sort by: </label>
                ...
                <button className='ml-2 sign_actionBtn btn dropdown-toggle' type="button" data-toggle="dropdown" aria-expanded="false">date</button>
                <div class="dropdown-menu">
                    <a className="dropdown-item" href='javascript:;'>Action</a>
                    <a className="dropdown-item"  href='javascript:;'>Another action</a>
                    <a className="dropdown-item"  href='javascript:;'>Something else here</a>
