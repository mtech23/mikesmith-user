            ...
            <div className='row'>
              <div className='col-sm-12 col-lg-7'>
                <div className='home_left_part'>
                  ...
                  <div className='platinum_feet_img'>
                    ...
                    <div className='actionBtns_and_searchBar'>
                      ...
                      <div className='main_searchBar'>
                        <input className='searchbar_input_field' type='text' placeholder='search post here'/>
                    ...
                    <div className='row py-3'>
                      <div className='col-4 col-sm-4 col-lg-5 mx-auto'>
                        <div className='legs_img_with_corners'>
                      ...
                      <div className='col-7 col-sm-7 col-lg-12 col-xl-7 align-self-center'>
                        <div className='legs_both_parts'>
                          ...
                          <div>
                            ...
                            <h4 className='legs_right_part_text_04'>authentic models</h4>
                            <h4 className='legs_right_part_text_05'>clients ethics</h4>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className='models_section'>
          <div className='container'>
            <div className='row'>
              <div className='col-md-12'>
                <div className='models_main_container'>
                  <div className='model_text_img text-center pb-5'>
                    <img src={modelText} />
                  </div>
                </div>
              </div>
              ...
              <div className='col-sm-6 col-lg-3'>
                <div className='first_model_card'>
                  ...
                  <div className='model_card_desc'>
                    <span className='card_short_para'>my pretty pink nails :)</span>
                  </div>
                  ...
                  <div>
                    <div className='model_have_a_look_btn'>
                      ...
                      <span className='be_nice_span'>BE NICE, or we will crush you!</span>
                    </div>
                  </div>
              ...
              <div className='col-sm-6 col-lg-3'>
                <div className='second_model_card'>
                  ...
                  <div className='model_card_desc'>
                    <span className='card_short_para'>Want to come play dress up with me?</span>
                  </div>
              ...
              <div className='col-sm-6 col-lg-3'>
                <div className='first_model_card'>
                  ...
                  <div className='model_card_desc'>
                    <span className='card_short_para'>my first post, what do you think? :)</span>
                  </div>
              ...
              <div className='col-sm-6 col-lg-3'>
                <div className='second_model_card'>
                  ...
                  <div className='model_card_desc'>
                    <span className='card_short_para'>come clean my feet with me, out in the...</span>
                  </div>
              ...
              <div className='col-sm-6 col-lg-3'>
                <div className='second_model_card'>
                  ...
                  <div className='model_card_desc'>
                    <span className='card_short_para'>be nice or we will crush you!</span>
                  </div>
            ...
            <div className='row py-5'>
              <div className='col-md-12'>
              <div className='how_it_works_text_img text-center'>
              ...
              <div className='col-sm-12 col-lg-8'>
                <div className='how_it_works_left_part'>
                  ...
                  <div className='how_it_works_left_img position-relative'>
            ...
            <div className='row pb-4'>
              <div className='col-md-12'>
                <div className='for_clients_main mb-3'>
                  ...
                  <div className='for_client_text_img text-center'>
              ...
              <div className='col-sm-8 col-lg-6 mx-auto mb-3'>
                <div className='for_client_left_img'>
                  <img src={forClientImg} className='img-fluid'/>
                </div>
              </div>

              <div className='col-sm-12 col-lg-6 align-self-center'>
                <div className='for_client_right_part'>
            ...
            <div className='row'>
              <div className='col-md-12'>
                <div className='for_models_text text-center mb-3'>
              ...
              <div className='col-md-12'>
                <div className='for_model_main'>
                  <div className='for_models_main_img'>
                      <img src={formodelImg01} className='img-fluid'/>
                  </div>

                  <div className='for_models_right_content my-auto'>
                  ...
                  <div className='for_model_most_right_img'>
            ...
            <div className='row'>
                <div className='col-md-12'>
                    <div className='faq_heading_text_img text-center'>
                      <img src={faqText}/>
                    </div>
                </div>
                ...
                <div className="accordion" id="accordionExample">
                  <div className="card">
                    <div className="card-header" id="headingOne">
                      <h2 className="mb-0">
                        <button className="btn faq_button btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div className="card-body">
                        Some placeholder content for the first accordion panel. This panel is shown by default className.
                      </div>
                    </div>
                  </div>
                  <div className="card">
                    <div className="card-header" id="headingTwo">
                      <h2 className="mb-0">
                        <button className="btn faq_button btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  ...
                  <div className="card">
                    <div className="card-header" id="headingThree">
                      <h2 className="mb-0">
                        <button className="btn faq_button btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                  ...
                  <div className="card">
                    <div className="card-header" id="headingfour">
                      <h2 className="mb-0">
                        <button className="btn faq_button btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
                  ...
                  <div className="card">
                    <div className="card-header" id="headingfive">
                      <h2 className="mb-0">
                        <button className="btn faq_button btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                          How many platinum points can I use towards my membership?
                        </button>
                      </h2>
                    </div>
