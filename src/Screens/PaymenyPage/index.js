            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    ...
                    <label className='namin'>  Name  </label>
                            <input className='nam' type="text" placeholder="FIRST LAST"  name="Name" /> 
                     <label className='namin'>  Card Number  </label>
                     <input className='card' type="number" placeholder="1234-5678-9101-1213"  name="Name" /> 
                            <div class="slct">
                            <div class="drop">
                            <label for="exampleFormControlSelect1" class="namin">EXPIRATION DATE</label>
                            <div class="drop1">
                            ...
                            <input className='cv' type="number" placeholder="123"  name="Name" /> 
                            </div>     
                          </div>  
                     ...
                     <div class="slct">
                            ...
                            <input className='state' type="text" placeholder="AZ"  name="Name" /> 
                            </div>
                           <div class="drop">
                           <label className='namin'>  ZIP CODE </label>
                            <input className='code' type="number" placeholder="9876"  name="Name" /> 
                           </div>
                            <div class="drop">
